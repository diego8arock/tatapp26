...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { coordinates: @zone.coordinates, project_id: @zone.project_id } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { coordinates: @zone.coordinates, project_id: @zone.project_id } }
