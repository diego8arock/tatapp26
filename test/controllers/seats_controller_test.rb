...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { assignmentDate: @seat.assignmentDate, id: @seat.id, name: @seat.name, project: @seat.project, status: @seat.status } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { assignmentDate: @seat.assignmentDate, id: @seat.id, name: @seat.name, project: @seat.project, status: @seat.status } }
