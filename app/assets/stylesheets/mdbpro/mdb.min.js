...
! function(e, t) {
    ...
    w.fn = w.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || g(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e) n = s[t], s !== (i = e[t]) && (c && i && (w.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, o = n && Array.isArray(n) ? n : []) : o = n && w.isPlainObject(n) ? n : {}, s[t] = w.extend(c, o, i)) : void 0 !== i && (s[t] = i));
        return s
    }, w.extend({
    ...
    var T = function(e) {
        var t, n, i, r, o, s, a, l, c, u, d, f, h, p, g, m, v, y, b, w = "sizzle" + 1 * new Date,
            _ = e.document,
            x = 0,
            T = 0,
            S = se(),
        ...
        for (t in n = oe.support = {}, o = oe.isXML = function(e) {
                        ...
                        return 1 === i && 0 === r ? function(e) {
                            ...
                            if (m) {
                                ...
                                if (p = [s ? m.firstChild : m.lastChild], s && y) {
                                    ...
                                    for (;
                                        (f = ++h && f && f[g] || (b = h = 0) || p.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && ((u = (d = f[w] || (f[w] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [x, b]), f !== t)););
                ...
                pseudos: {
                    ...
                    lang: ae(function(e) {
                        return X.test(e || "") || oe.error("unsupported lang: " + e), e = e.replace(J, ee).toLowerCase(),
                            function(t) {
                                var n;
                                do {
        ...
        function _e(e, t, n, i, r, o) {
            return i && !i[w] && (i = _e(i)), r && !r[w] && (r = _e(r, o)), ae(function(o, s, a, l) {
                var c, u, d, f = [],
                    ...
                    m = !e || !o && t ? g : we(g, f, e, a, l),
                    v = n ? r || (o ? e : p || i) ? [] : s : m;
                if (n && n(m, v, a, l), i)
                    for (c = we(v, h), i(c, [], a, l), u = c.length; u--;)(d = c[u]) && (v[h[u]] = !(m[h[u]] = d));
                if (o) {
                    if (r || e) {
                        if (r) {
            ...
            var n = t.length > 0,
                ...
                o = function(o, s, a, l, u) {
                    ...
                    for (u && (c = s === h || s || u); y !== C && null != (d = T[y]); y++) {
                        if (r && d) {
                            for (p = 0, s || d.ownerDocument === h || (f(d), a = !g); m = e[p++];)
                                if (m(d, s || h, a)) {
                                    l.push(d);
                                    break
                                }
    ...
    function me(e, t, n, i, r) {
        ...
        for (d.textContent = "", h = 0; o = f[h++];)
            ...
            else if (c = w.contains(o.ownerDocument, o), s = he(d.appendChild(o), "script"), c && pe(s), n)
    ...
    w.event = {
        ...
        add: function(e, t, n, i, r) {
            ...
            if (m)
                for (n.handler && (n = (o = n).handler, r = o.selector), r && w.find.matchesSelector(ve, r), n.guid || (n.guid = w.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
            ...
            if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                for (s = w.event.handlers.call(this, a, c), t = 0;
                    ...
                    for (a.currentTarget = r.elem, n = 0;
                        (o = r.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !a.rnamespace.test(o.namespace) || (a.handleObj = o, a.data = o.data, void 0 !== (i = ((w.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
    ...
    function Le(e, t, n, i) {
        ...
        if (f && (o = (r = me(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
            ...
            if (l)
                for (u = a[a.length - 1].ownerDocument, w.map(a, De), d = 0; d < l; d++) c = a[d], de.test(c.type || "") && !Q.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && w._evalUrl(c.src) : y(c.textContent.replace(Ae, ""), u, c))
        }
        return e
    }
    ...
    w.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(p.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
                for (s = he(a), i = 0, r = (o = he(e)).length; i < r; i++) Ne(o[i], s[i]);
            if (t)
                if (n)
                    for (o = o || he(e), s = s || he(a), i = 0, r = o.length; i < r; i++) Ie(o[i], s[i]);
                else Ie(e, a);
    ...
    function st(e, t, n) {
        ...
        for (function(e, t) {
                var n, i, r, o, s;
                for (n in e)
                    if (r = t[i = X(n)], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = w.cssHooks[i]) && "expand" in s)
                        for (n in o = s.expand(o), delete e[i], o) n in e || (e[n] = o[n], t[n] = r);
                    else t[i] = r
            }(u, c.opts.specialEasing); o < s; o++)
            if (i = st.prefilters[o].call(c, e, u, c.opts)) return g(i.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
    ...
    w.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : g(e) ? this.each(function(n) {
                ...
                var t, r, o, s;
                if (i)
                    for (r = 0, o = w(this), s = ht(e); t = s[r++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
    ...
    w.extend(w.event, {
        trigger: function(t, n, r, o) {
            ...
            if (a = p = l = r = r || i, 3 !== r.nodeType && 8 !== r.nodeType && !gt.test(y + w.event.triggered) && (y.indexOf(".") > -1 && (y = (b = y.split(".")).shift(), b.sort()), u = y.indexOf(":") < 0 && "on" + y, (t = t[w.expando] ? t : new w.Event(y, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : w.makeArray(n, [t]), h = w.event.special[y] || {}, o || !h.trigger || !1 !== h.trigger.apply(r, n))) {
                ...
                for (s = 0;
                    (a = v[s++]) && !t.isPropagationStopped();) p = a, t.type = s > 1 ? c : h.bindType || y, (f = (Q.get(a, "events") || {})[t.type] && Q.get(a, "handle")) && f.apply(a, n), (f = u && a[u]) && f.apply && z(a) && (t.result = f.apply(a, n), !1 === t.result && t.preventDefault());
    ...
    Lt.href = vt.href, w.extend({
        ...
        ajax: function(t, n) {
            ...
            var r, o, s, a, l, c, u, d, f, h, p = w.ajaxSetup({}, n),
                g = p.context || p,
                ...
                S = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (u) {
                            if (!a)
                                for (a = {}; t = At.exec(s);) a[t[1].toLowerCase()] = t[2];
                            t = a[e.toLowerCase()]
                        }
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var a, l, c = void 0 === s ? t.gpuAcceleration : s,
                        ...
                        v = A("transform");
                    if (l = "bottom" == g ? "HTML" === u.nodeName ? -u.clientHeight + h.bottom : -d.height + h.bottom : h.top, a = "right" == m ? "HTML" === u.nodeName ? -u.clientWidth + h.right : -d.width + h.right : h.left, c && v) f[v] = "translate3d(" + a + "px, " + l + "px, 0)", f[g] = 0, f[m] = 0, f.willChange = "transform";
                    else {
                        var y = "bottom" == g ? -1 : 1,
                            b = "right" == m ? -1 : 1;
...
function(e, t) {
            ...
            var t = "carousel",
                ...
                T = function() {
                    ...
                    return T.next = function() {
                        ...
                        if (t === u ? (i = b, r = w, o = f) : (i = y, r = _, o = h), d && e(d).hasClass(m)) this._isSliding = !1;
    ...
    }(t), e.Util = a, e.Alert = l, e.Button = c, e.Carousel = u, e.Collapse = d, e.Dropdown = f, e.Modal = h, e.Popover = g, e.Scrollspy = m, e.Tab = v, e.Tooltip = p, Object.defineProperty(e, "__esModule", {
        value: !0
    })
                        ...
                        if (v.State.calls[r]) {
                            ...
                            for (var m = Math.min((t - f) / d.duration, 1), y = 0, w = a.length; w > y; y++) {
                                ...
                                if (o(T)) {
                                    ...
                                    for (var C in d.visibility !== i && "hidden" !== d.visibility && b.setPropertyValue(T, "visibility", d.visibility), x)
                                        if ("element" !== C) {
                                            var E, k = x[C],
                                                A = h.isString(k.easing) ? v.Easings[k.easing] : k.easing;
                                            if (1 === m) E = k.endValue;
                                            else {
                ...
                var w = function() {
                    ...
                    function s() {
                        function e(e) {
                            ...
                            if ("scroll" === E) {
                                var w, x, C, A = /^x$/i.test(c.axis) ? "Left" : "Top",
                                ...
                                for (var N in o(s).tweensContainer && !0 === o(s).isAnimating && (P = o(s).tweensContainer), u.each(y, function(e, t) {
                                    ...
                                    if (o(s).isSVG || "tween" === R || !1 !== b.Names.prefixCheck(R)[1] || b.Normalizations.registered[R] !== i) {
                                        ...
                                        if (W = (F = p(N, W))[0], V = F[1], H = (F = p(N, H))[0].replace(/^([+-\/*])=/, function(e, t) {
                                                return Y = t, ""
                                            }), B = F[1], W = parseFloat(W) || 0, H = parseFloat(H) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(N) ? (H /= 100, B = "em") : /^scale/.test(N) ? (H /= 100, B = "") : /(Red|Green|Blue)$/i.test(N) && (H = H / 100 * 255, B = "")), /[\/*]/.test(Y)) B = V;
                                        else if (V !== B && 0 !== W)
                                            if (0 === H) B = V;
                                            else {
                                                r = r || g();
        ...
        e.fn.scrollTo = function(t) {
            ...
            this.each(function() {
                ...
                function a(t) {
                    ...
                    var g = 0,
                        m = n.parent();
                    if (!m.is("body") && m[0].scrollHeight > m[0].clientHeight && (g = m[0].scrollTop), c + o.innerWidth() > e(window).width() ? d = "right" : c - o.innerWidth() + n.innerWidth() < 0 && (d = "left"), u + o.innerHeight() > a)
    ...
    function(e, t, n, i) {
            ...
            n.isFirst = !!s, n.isFinal = !!a, s && (e.session = {}), n.eventType = t,
                function(e, t) {
                    ...
                    var s = n.firstInput,
                        ...
                        d = t.center = J(r);
                    t.timeStamp = u(), t.deltaTime = t.timeStamp - s.timeStamp, t.angle = ie(l, d), t.distance = ne(l, d),
                        function(e, t) {
                            var n = t.center,
                                i = e.offsetDelta || {},
                                r = e.prevDelta || {},
        ...
        We.prototype = {
            ...
            process: function(e) {
                ...
                if (this._input = e, !i || !n || e.eventType & ($ | W) && !r) this.reset();
                else if (e.eventType & M) this.reset(), this._timer = d(function() {
                    this.state = He, this.tryEmit()
                }, t.time, this);
                else if (e.eventType & $) return He;
                return 32
            },
            reset: function() {
            ...
            remove: function(e) {
                ...
                if (e = this.get(e)) {
                    var t = this.recognizers,
                        n = E(t, e); - 1 !== n && (t.splice(n, 1), this.touchAction.update())
                }
                return this
            },
            on: function(e, t) {
                ...
                return _createClass(n, [{
                    ...
                    value: function() {
                        ...
                        "left" === this.options.edge ? (this.$menu.css("transform", "translateX(-100%)"), this.$dragTarget.css({
                            ...
                            right: 0
                        })), this.$menu.hasClass("fixed") && (window.innerWidth > 1440 && this.$menu.css("transform", "translateX(0)"), e(window).resize(function() {
                            if (window.innerWidth > 1440) t.$sidenavOverlay.length ? t.removeMenu(!0) : t.$menu.css("transform", "translateX(0%)");
                            else if (!1 === t.menuOut) {
                ...
                return _createClass(n, [{
                    ...
                    value: function() {
                        if (this.stopPoint < e(this.$element).offset().top + this.$element.height()) {
                            ...
                            "bottom" === this.options.startScrolling && (t = this.stopPoint - (this.scrollTop + this.elementHeight)), this.$element.css({
                                top: t
                            })
                        }
                    }
                ...
                t.event.bind(t.ownerDocument, "keydown", function(i) {
                    if (!(i.isDefaultPrevented && i.isDefaultPrevented() || i.defaultPrevented)) {
                        ...
                        if (n || s) {
                            ...
                            l(e, "top", e.scrollTop - d), l(e, "left", e.scrollLeft + u), a(e),
                                function(n, i) {
                                    var r = e.scrollTop;
                                    if (0 === n) {
                    ...
                    for (var t in n) {
                        ...
                        if (e.language && i[e.language] && !i[e.language].initialized) {
                            ...
                            "Array" !== Prism.util.type(r) && (r = [r]), r.forEach(function(r) {
                                var o, s, a, l;
                                !0 === r ? (o = "important", s = e.language, r = e.language) : (o = r.before || "important", s = r.inside || r.lang, a = r.root || Prism.languages, l = r.skip, r = e.language), !l && Prism.languages[r] && (Prism.languages.insertBefore(s, o, n[t].tokens, a), e.grammar = Prism.languages[r], i[e.language] = {
                                    initialized: !0
                                })
                            })
                        }
